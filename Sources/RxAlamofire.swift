...
/**
 ...
 - returns: An observable of a the `Request`
 */
public func request(_ urlRequest: URLRequestConvertible) -> Single<DataRequest> {
...
/**
 ...
 - returns: An observable of a tuple containing `(NSHTTPURLResponse, NSData)`
 */
public func requestData(_ urlRequest: URLRequestConvertible) -> Single<(HTTPURLResponse, Data)> {
...
/**
 ...
 - returns: An observable of the tuple `(NSHTTPURLResponse, String)`
 */
public func requestString(_ urlRequest: URLRequestConvertible) -> Single<(HTTPURLResponse, String)> {
...
/**
 ...
 - returns: An observable of the tuple `(NSHTTPURLResponse, AnyObject)`
 */
public func requestJSON(_ urlRequest: URLRequestConvertible) -> Single<(HTTPURLResponse, Any)> {
 ...
 */
public func upload(_ file: URL, urlRequest: URLRequestConvertible) -> Single<UploadRequest> {
...
/**
 ...
 - returns: The observable of `UploadRequest` for the created request.
 */
public func upload(_ data: Data, urlRequest: URLRequestConvertible) -> Single<UploadRequest> {
 ...
 */
public func upload(_ stream: InputStream, urlRequest: URLRequestConvertible) -> Single<UploadRequest> {
...
public func download(_ urlRequest: URLRequestConvertible,
                     to destination: @escaping DownloadRequest.DownloadFileDestination) -> Single<DownloadRequest> {
...
extension Reactive where Base: SessionManager {
     ...
     */
    func request<R: RxAlamofireRequest>(_ createRequest: @escaping (SessionManager) throws -> R) -> Single<R> {
    ...
    public func upload(_ stream: InputStream,
                       urlRequest: URLRequestConvertible) -> Single<UploadRequest> {
        return request { manager in
...
extension Reactive where Base: DataRequest {
    ...
    public func responseJSON() -> Single<DataResponse<Any>> {
        return .create { (singleEventListener) in
    ...
    /**
     ...
     - returns: An instance of `Single<NSData>`
     */
    ...
    /**
     ...
     - returns: An instance of `Single<AnyData>`
     */
    public func responsePropertyList(options: PropertyListSerialization.ReadOptions = PropertyListSerialization.ReadOptions()) -> Single<(HTTPURLResponse, Any)> {
        return responseResult(responseSerializer: Base.propertyListResponseSerializer(options: options))
    }
    
    public func propertyList(options: PropertyListSerialization.ReadOptions = PropertyListSerialization.ReadOptions()) -> Single<Any> {
